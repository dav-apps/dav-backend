class ProvidersController < ApplicationController
	def create_provider
		...
		ValidationService.raise_validation_error(ValidationService.validate_country_presence(country))
		ValidationService.raise_validation_error(ValidationService.validate_country_type(country))
		...
		ValidationService.raise_validation_error(ValidationService.validate_provider_nonexistence(session.user.provider))
